...
# create FastAPI app
app = FastAPI(title="Movie Recommendation API", description="API for movie recommendations based on user input.", version="3.0.0")

# configure CORS middleware to allow requests from any origin of frontend application
app.add_middleware(
CORSMiddleware, 
allow_origins=["*"], 
